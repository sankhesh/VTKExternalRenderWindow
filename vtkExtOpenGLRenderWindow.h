/*=========================================================================
  ...
  Module:    vtkExtOpenGLRenderWindow.h
...
=========================================================================*/
// .NAME vtkExtOpenGLRenderWindow - OpenGL rendering window
// .SECTION Description
// vtkExtOpenGLRenderWindow is a concrete implementation of the abstract class
...
class VTKRENDERINGOPENGL_EXPORT vtkExtOpenGLRenderWindow : public vtkOpenGLRenderWindow
{
public:
  static vtkExtOpenGLRenderWindow *New();
  vtkTypeMacro(vtkExtOpenGLRenderWindow,vtkOpenGLRenderWindow);
...
private:
  vtkExtOpenGLRenderWindow(const vtkExtOpenGLRenderWindow&);  // Not implemented.
  void operator=(const vtkExtOpenGLRenderWindow&);  // Not implemented.
};
